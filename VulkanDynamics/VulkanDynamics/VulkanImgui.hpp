...
namespace VkApplication {
	...
	void MainVulkApplication::createImguiContext() {
...

		{
			...
			//VkCommandPool command_pool = imgui_window.Frames[imgui_window.FrameIndex].CommandPool;
			//VkCommandBuffer command_buffer = imgui_window.Frames[imgui_window.FrameIndex].CommandBuffer;
